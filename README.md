...
A browser extension which adds a tab context menu item (Firefox & Chrome) and a button action (Firefox & Chrome) to move a tab to the next window - or to a specific window of your choosing.
